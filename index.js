...
const handlers = {
    'LaunchRequest': function () {
      ...
      //  var gg=this.getResponse();
       // this.speak("got it!" + gg);
    },
    'GetNewFactIntent': function () {
       // this.emit('', this.event.request.intent.slots.boolean.value);
        const factArr = data;
    ...
    'TestFactIntent': function () {
        const factArr = data;
        const factIndex = Math.floor(Math.random() * factArr.length);
        const randomFact = factArr[factIndex];
        const speechOutput = GET_FACT_MESSAGE + randomFact;

        this.response.cardRenderer(SKILL_NAME, "Does thyis work?");
        this.response.speak("Does thyis work?");
        this.emit(':responseReady');
    },
